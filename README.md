...
2. Dollar sign ($): This symbol is used to denote variables in Makefiles. Using is as simple as typing it this way $(variable_name), where variable_name is something you have defined into the Makefile before this line is executed by Make.
